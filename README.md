...
**Fantasilandia 2.0** es un sistema de información de escritorio para gestionar un parque de atracciones. Desarrollado en Java (JDK 11) con interfaz gráfica **Java Swing**, aplicando principios de **Programación Orientada a Objetos**.
...
|---|---|
| ![Menu](Fantasilandia4.0/src/screenshots/menu_principal.png) | ![Atracciones](Fantasilandia4.0/src/screenshots/Gestion_atracciones.png) |

| Bloques de horario | Gestión de clientes |
|---|---|
| ![Bloques](Fantasilandia4.0/src/screenshots/Bloques_de_horario.png) | ![Clientes](Fantasilandia4.0/src/screenshots/Gestion_Clientes.png) |

| Reportes y filtros | |
|---|---|
| ![Reportes](Fantasilandia4.0/src/screenshots/Reportes_Filtros.png) | |
