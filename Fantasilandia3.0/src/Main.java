...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            System.out.println("7. Gestionar Bloques de Horario(Insertar/Listar de 1ª colección)");
            System.out.println("8. Gestionar Horarios en Atracciones(Insertar/Listar de 2ª colección)");
